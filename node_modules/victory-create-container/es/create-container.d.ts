...
export declare function makeCreateContainerFunction<TContainerComponents extends ContainerComponents>(containerComponents: TContainerComponents, VictoryContainerBase: typeof VictoryContainer): <TContainerA extends ContainerType, TContainerB extends ContainerType>(containerA: TContainerA, containerB: TContainerB) => {
    (props: React.ComponentProps<TContainerComponents[TContainerA]> & React.ComponentProps<TContainerComponents[TContainerB]>): JSX.Element;
    displayName: string;
    role: string;
    defaultEvents(props: React.ComponentProps<TContainerComponents[TContainerA]> & React.ComponentProps<TContainerComponents[TContainerB]>): ({
        target: string;
        eventHandlers: any;
    } | null)[];
};
export declare const createContainer: <TContainerA extends ContainerType, TContainerB extends ContainerType>(containerA: TContainerA, containerB: TContainerB) => {
    ...
    }[TContainerB]>): JSX.Element;
    displayName: string;
    role: string;
    defaultEvents(props: React.ComponentProps<{
        zoom: {
            (initialProps: import("victory-zoom-container").VictoryZoomContainerProps): JSX.Element;
            role: string;
            defaultEvents(initialProps: import("victory-zoom-container").VictoryZoomContainerProps): {
